...
public class FastBlurUtil {
     ...
     * 获得模糊化的背景图片
     *
     * @param view 获取模糊化的背景view
     * @return 模糊化的背景图片
     */
    public static Bitmap getBlurBackgroundDrawer(View view) {
        Bitmap bmp = takeScreenShot(view);
        return startBlurBackground(bmp);
    }
     ...
     * 获得模糊化的背景图片
     *
     * @param bitmap 获取模糊化的背景view
     * @return 模糊化的背景图片
     */
    public static Bitmap getBlurBackgroundDrawer(Bitmap bitmap) {
        Bitmap bmp = takeScreenShot(bitmap);
        return startBlurBackground(bmp);
    }
     ...
     * @return 模糊化的背景图片
     */
    public static Bitmap getBlurBackgroundDrawer(Activity activity, View view) {
     ...
     * 截屏
     *
     * @param bitmap 截屏的activity
     * @return 截屏图片
     */
    private static Bitmap takeScreenShot(Bitmap bitmap) {
